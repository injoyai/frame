...
<head>
    ...
    <style>
        :root {
            --primary-color: #4090de; /* Approx 64,144,222 */
            --text-color: #000;
            --desc-color: #666;
        }
        ...
        .error-container {
            ...
            align-items: center;
            justify-content: center;
            flex-direction: column; /* Default to column for mobile or if needed */
        }
        ...
        .btn {
            ...
            padding: 12px 20px;
            font-size: 14px;
            border-radius: 20px; /* round="" usually implies pill shape */
...
<body>
    <div class="error-container">
        <div class="pic" id="lottie-container"></div>
        <div class="right">
            <h2 class="title">似乎出了点问题</h2>
            <p class="desc">请检查您的URL是否正确, 或点击返回</p>
